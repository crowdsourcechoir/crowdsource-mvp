...
assert.equal(
  classifyQueueCategory({
    ...
    opportunityTitle: "Fan Engagement Initiative",
    opportunityTypeKey: "fan_engagement_initiative",
    organizationTypeKey: "sports_team",
  }),
  "sports"
...
assert.equal(
  classifyQueueCategory({
    organizationName: "Learfield",
    opportunityTitle: "College athletics media",
...
assert.equal(
  classifyQueueCategory({
    organizationName: "Consumer Technology Association / CES 2027",
    opportunityTitle: "CES 2027 — participatory anthem",
    opportunityTypeKey: "annual_conference",
    organizationTypeKey: "conference",
  }),
  "conferences"
