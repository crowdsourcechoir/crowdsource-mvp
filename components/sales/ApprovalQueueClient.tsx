...
export default function ApprovalQueueClient() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      setGmailSendEnabled(Boolean(data.gmail?.sendEnabled));
      setError(null);
      setSelectedIndex(0);
            ...
            <div>
              ...
              {gmailConnected ? (
                <p className="mt-1 text-sm text-emerald-400">
                  ...
                  {gmailSendEnabled
                    ...
                    : " — sending PAUSED (SALES_GMAIL_SEND_ENABLED off)"}
                  {gmailSendEnabled &&
                  current.queueItem.kind === "nudge" &&
              ...
              {!gmailSendEnabled && (
                <p className="mt-1 text-xs text-amber-400">
                  ...
                  <code className="text-amber-200">SALES_GMAIL_SEND_ENABLED=true</code> in Vercel and
                  redeploy.
                </p>
              )}
              {current.opportunity.gmailThreadId && (
